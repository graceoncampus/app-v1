...
import { Text, Icon, Tile, Divider, Screen, View, TouchableOpacity, TextInput, Subtitle, FormGroup, Caption, Button, Spinner, Title } from '@shoutem/ui';
...
class FirstLoad extends Component {
  ...
  render() {
    ...
    return (
      <Screen>
        <Tile style={{ paddingTop: 20, paddingBottom: 0, flex: 0.28, backgroundColor: 'transparent' }} styleName='text-centric'>
